...
@pytest.mark.parametrize("start, end,expected", [
    ('2020-01-07 09:31', '2020-01-07 15:01', 242),
    ('2020-01-07 11:30', '2020-01-07 13:01', 3),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('2020-01-07 11:30', '2020-01-07 11:31'),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('2020-01-07 13:00', '2020-01-07 11:31'),
        ('2020-01-07 13:01', '2020-01-07 11:31'),
        # 跨日
        ('2020-01-07 09:31', '2020-01-06 15:01'),
    ])
